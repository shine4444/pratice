...
* @{
*/
#define PRODUCT_KEY "6f2d251905d54ac0b70006c82e19c7cb"
/**@} */
/**@name Product Secret (产品密钥)
* @{
*/
#define PRODUCT_SECRET "dc4d2ad634a84061a1af61ebe156749f"
/**@} */
...
#define TEMPERATURE_ADDITION                      15
#define TEMPERATURE_MIN                           0
#define TEMPERATURE_MAX                           25

#define GEAR_RATIO                         1
#define GEAR_ADDITION                      1
#define GEAR_MIN                           0
#define GEAR_MAX                           2
